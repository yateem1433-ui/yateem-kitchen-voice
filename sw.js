// Service worker ของแอปบอทครัว - อยู่คนละ repo/path กับ Yateem Market (/yateem-kitchen-web/) จึงไม่ยุ่งกับหน้า Market
// (เดิมบอทครัวอยู่ใต้ scope ของแอป Market ทำให้ Android ติดตั้ง/เปิดเป็นแอป Market แทน)
